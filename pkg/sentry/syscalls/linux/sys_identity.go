...
func Getresuid(t *kernel.Task, args arch.SyscallArguments) (uintptr, *kernel.SyscallControl, error) {
	...
	if err := ruid.CopyOut(t, ruidAddr); err != nil {
		return 0, nil, err
	}
	if err := euid.CopyOut(t, euidAddr); err != nil {
		return 0, nil, err
	}
	if err := suid.CopyOut(t, suidAddr); err != nil {
		return 0, nil, err
	}
	return 0, nil, nil
}
...
func Getresgid(t *kernel.Task, args arch.SyscallArguments) (uintptr, *kernel.SyscallControl, error) {
	...
	if err := rgid.CopyOut(t, rgidAddr); err != nil {
		return 0, nil, err
	}
	if err := egid.CopyOut(t, egidAddr); err != nil {
		return 0, nil, err
	}
	if err := sgid.CopyOut(t, sgidAddr); err != nil {
		return 0, nil, err
	}
	return 0, nil, nil
}
...
func Getgroups(t *kernel.Task, args arch.SyscallArguments) (uintptr, *kernel.SyscallControl, error) {
	...
	if err := auth.CopyGIDSliceOut(t, args[1].Pointer(), gids); err != nil {
		return 0, nil, err
	}
...
func Setgroups(t *kernel.Task, args arch.SyscallArguments) (uintptr, *kernel.SyscallControl, error) {
	...
	if err := auth.CopyGIDSliceIn(t, args[1].Pointer(), gids); err != nil {
		return 0, nil, err
	}
