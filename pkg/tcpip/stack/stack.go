...
type Options struct {
	...
	// header.IIDSize bytes to make sure that temporary SLAAC addresses seem
	// random. It should follow minimum randomness requirements for security as
	// outlined by RFC 4086.
	//
