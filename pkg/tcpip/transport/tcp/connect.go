...
// startHandshake resolves the route if necessary and sends the first
// SYN/SYN-ACK.
func (h *handshake) startHandshake() *tcpip.Error {
	...
	h.ep.sendSynTCP(&h.ep.route, h.ep.ID, h.ep.ttl, h.ep.sendTOS, h.flags, h.iss, h.ackNum, h.rcvWnd, h.sendSYNOpts)
	return nil
}
